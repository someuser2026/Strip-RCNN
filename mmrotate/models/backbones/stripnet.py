...
class StripBlock(nn.Module):
    def __init__(self, dim, k1, k2):
        ...
        self.strip_conv1 = nn.Conv2d(dim,dim,kernel_size=(k1, k2), stride=1, padding=(k1//2, 0), groups=dim)     
        self.strip_conv2 = nn.Conv2d(dim,dim,kernel_size=(k1, k2), stride=1, padding=(0, k2//2), groups=dim)
